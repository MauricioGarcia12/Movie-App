        ...
        <div class="container mx-auto flex flex-col sm:flex-row md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-2 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 py-1 pl-6 focus:outline-none focus:shadow-outline" placeholder="Search Movie">
                ...
                <div class="md:ml-4 mt-2 md:mt-0">
                    <a href="#">
                        <a href="#">
                            <img class="rounded-full w-8 h-8" src="/img/foto.jpg" alt="">
                        </a>
                    </a>
                </div>
